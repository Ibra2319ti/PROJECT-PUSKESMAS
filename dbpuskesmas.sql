...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2024 at 04:44 PM
...
CREATE TABLE `paramedik` (
  ...
  `kategori` enum('Dokter GIGI','Bidan') NOT NULL,
...
(1, 'ibahi', '1', 'mafioqwq0', '2022-09-28', 'Dokter GIGI', '19910388', 'edjojpa', 1);
...
(3, 'A108', 'Nagita nafisa', 'Jogja', '1993-03-08', '0', 'nagtnfsaa@gmail.com', 'Jogja, Jawa tengah', 3);
...
(0, '2008-02-12', 77, 178, '67', 'sehat', 3, 1);
...
(1, 'faqihuddin', 'faqihuddn17@gmail.com', '202cb962ac59075b964b07152d234b70', 'admin');
...
--
ALTER TABLE `paramedik`
  ADD CONSTRAINT `fk_unit_kerja` FOREIGN KEY (`unit_kerja_id`) REFERENCES `unit_kerja` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `periksa`
  ...
  ADD CONSTRAINT `fk_pasien_id` FOREIGN KEY (`pasien_id`) REFERENCES `pasien` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
